...
def main() -> None:
    parser = argparse.ArgumentParser(description="Single-vessel convergence study")
    ...
    output_dir = args.output_dir or Path(f"examples/outputs/convergence_single_{args.method}")
